  ...
  return (
    <div className="grid min-h-screen w-full lg:grid-cols-[300px_1fr]">
      ...
      <div className="flex flex-col">
        <header className="flex h-14 lg:h-[60px] items-center gap-4 border-b border-gray-200 bg-gray-100/40 px-6 dark:border-gray-800 dark:bg-gray-800/40">
        ...
        <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6">
          <div className="grid gap-2">
            ...
            <p className="text-gray-500 dark:text-gray-400">Your tasks at a glance</p>
          </div>
          <div className="grid gap-4">
            <div className="border rounded-lg p-4">
              <div className="grid gap-2">
                <h3 className="font-semibold">To Do</h3>
                <div className="grid gap-2">CARD</div>
              </div>
            </div>
            <div className="border rounded-lg p-4">
              <div className="grid gap-2">
