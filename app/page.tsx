      ...
      <Card className="w-[300px] sm:w-[350px]">
        ...
        <CardContent className="grid gap-4">
          <div className="grid gap-2">
            ...
            />
            <Link className="text-right text-xs text-slate-500 hover:underline hover:text-slate-300" href="/forgotpassword">
              Forgot Password
            </Link>
          </div>
          <div className="grid gap-2">
        ...
        <CardFooter className="flex justify-between">
          <Button disabled={user.email.length > 0 && user.password.length > 0 ? false : true}>
